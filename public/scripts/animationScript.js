...
window.onscroll = function() {
  ...
  // animation for section - about
    ...
    if (aboutTop + 300 < windowHeight && aboutBottom + 300 > windowHeight) {
    ...
    if (experienceTop + 300 < windowHeight && experienceBottom + 300 > windowHeight) {
    ...
    if (projectsTop + 300 < windowHeight && projectsBottom + 300 > windowHeight) {
